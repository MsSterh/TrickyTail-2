        ...
        <View style={styles.container}>
          ...
          <AccordionItem title="Сет: отжимания + спина + пресс">
            ...
            <Text style={styles.text}>
              ...
              затем сгибание коленей и выравнивание ног вверху, снова сгибание и
          ...
          <AccordionItem title="Сет: руки с гантелями по 3 кг">
            <Text style={styles.text}>
              20 раз. Стоя с согнутыми коленями, корпус на 30 градусов наклонен вперед.
              Руки внизу и заводим их к себе назад (локти назад).
            </Text>
            <Text style={styles.text}>
              12 раз. Стоя ровно, мягкие колени, руки внизу ладоняни наружу. Поднимаем руки вперед до
              уровня глаз, ладони наверх.
            </Text>
            <Text style={styles.text}>
              12 раз. Стоя ровно, мягкие колени, руки внизу по бокам. Поднимаем руки в стороны
              (ладонь вниз), проворачиваем чтобы ладонь смотрела наверх, затем сводим руки над головой.
              Опускаем в обратной последовательности.
            </Text>
            <Text style={styles.text}>
              20 раз. Стоя ровно, мягкие колени, руки вверху, локти у головы (не разводим их),
              сгинаем локти, чтобы кисти были за головой, и снова выпрямляем.
            </Text>
            <Text style={styles.text}>
              1 минуту. Стоя ровно, мягкие колени, в руках одна гантеля. Руки вытянуты вперед на
              уровне груди и держат одну гантелю с боков. Крутим ее в темпе в одну и сразу в другую сторону.
            </Text>
          </AccordionItem>
