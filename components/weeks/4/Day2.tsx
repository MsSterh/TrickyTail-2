...
export default function Day2() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.text}>Растяжка + дыхание.</Text>
      <CheckItem
        setCount={setCount}
      ...
      <CheckItem
        setCount={setCount}
        text="Возьми кубики и коврик. Активно покатайся на ноге 10 раз: ровные ноги широко (одна впереди, другая сзади), сгибай колено передней ноги и чувствуй растяжение передней части бедра задней ноги, затем вставай, выравнивай колено передней ноги чувствуй растяжение под коленом. Руки на кубиках по бокам тела. Поменяй ногу и повтори 20 раз."
      />
      <CheckItem
        setCount={setCount}
        text="Сядь в полушпагат (передняя нога согнута, ступня на полу, задняя на носке). Положи заднюю ногу на тыльную сторону ступни. Руки возле передней ноги. Покачайся 10 раз. По возможности опусти руки на локти, просунь руку под коленом и снова покачайся 20 раз. Повтори на другую ногу."
      />
      <CheckItem
        setCount={setCount}
