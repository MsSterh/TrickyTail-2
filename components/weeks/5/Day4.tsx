...
export default function Day4() {
  ...
  return (
    <View style={styles.container}>
      <DayDescription rate={2} time="0:15" text="Баланс, стопы и глаза." />
      <CheckItem
        setCount={setCount}
      ...
      <CheckItem
        setCount={setCount}
        text="Цапля. Встань ровно, руки вверху ладошками соединены, одна нога согнута + её стопа на колене другой ноги и ее колено отведенено в сторону. Постой так 30 секунд на одну ногу и 30 секунд на другую. Делай это с закрытыми глазами."
      />
      <CheckItem
        setCount={setCount}
        text="Встань ровно, руки на поясе. Сделай 10 шагов вперед как по канату, по одной линии, пяткой касайся носка задней ноги. После каждого шага досчитай медленно до 5, затем делай следующий шаг. Начиная с третьего шага закрой глаза."
      />
      <CheckItem
        setCount={setCount}
