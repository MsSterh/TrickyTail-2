...
export default function Day1() {
  ...
  return (
    <View style={styles.container}>
      <DayDescription rate={4} time="0:16" text="Бёрпи + пресс + спина." />
      <CheckItem
        setCount={setCount}
      ...
      <CheckItem
        setCount={setCount}
        text="Стой ровно. Руки за головой, сгибай поочерено колени в бок правой, потом левой ногой. Чувствуй бочка. По 10 раз на каждую сторону."
      />
      <CheckItem
        setCount={setCount}
        text="Постой в планке на прямых руках 1 минуту. Затем по полминуты на одной стороне (свободная рука вверху), затем на другой."
      />
      <CheckItem
        setCount={setCount}
